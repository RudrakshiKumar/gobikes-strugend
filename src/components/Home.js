    ...
    <>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6}>
          ...
          >
            <Typography variant="h4" fontFamily={"Poppin"}>
              Commuting Made <span style={{ color: "#59CE8F" }}>Easy</span>,
              <br />
            </Typography>
            <Typography variant="h4" fontFamily={"Poppin"} sx={{ marginTop: "5px" }}>
              <span style={{ color: "#59CE8F" }}>Affordable</span> and{" "}
              <span style={{ color: "#59CE8F" }}>Quick</span>
            </Typography>
            <Typography variant="h6" fontFamily={"Poppin"} fontWeight={"bold"} sx={{ marginTop: "2px" }}>
            ...
            >
              <Box sx={style}>
                <Typography id="modal-modal-title" variant="h6" component="h2" fontFamily={"Poppin"}>
            ...
            {/* <TextField
              ...
              /> */}
            <Typography variant="p" fontFamily={"Poppins"} fontSize={'18px'} sx={{ marginTop: "2%" }}>
              Duration: 1 Day
            </Typography>
            <Button
              variant="contained"
