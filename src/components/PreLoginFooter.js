    ...
    <Box sx={{ bgcolor: "#d6fbe6" }}>
      <Box sx={{ mt: 20 }} className="relative z-50">
        ...
        >
          ...
          <Box sx={{}}>
            <Link to="/ContactUs">
              <Typography sx={{ color: "#000000", fontFamily:"Poppin", fontSize:"18px", mb: 2 }}>
                Contact Us
              </Typography>
            </Link>
            ...
            <Link to="/TermsCondition">
              <Typography sx={{ color: "#000000", fontFamily:"Poppin", fontSize:"18px", }}>
          ...
          <Box sx={{}}>
            <Link to="/OffersForYou">
              <Typography sx={{ color: "#000000", fontFamily:"Poppin", fontSize:"18px", mb: 2 }}>Offers</Typography>
            </Link>
            ...
            <Link to="/FAQs">
              <Typography sx={{ color: "#000000", fontFamily:"Poppin", fontSize:"18px", }}>FAQs</Typography>
            </Link>
          </Box>
          <Box sx={{}}>
            <Link to="/AboutUs">
              <Typography sx={{ color: "#000000", fontFamily:"Poppin", fontSize:"18px", mb: 2 }}>About Us</Typography>
            </Link>
            <button
            sx={{ fontFamily: "Poppin", fontSize: "18px" }}
              // sx={{ color: "#000000" }}
        ...
        >
          <Box sx={{}}>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Agra</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Ahmedabad</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Bangalore</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Chandigarh</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Chennai</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Monthly Bike Rental</Typography>
          </Box>
          <Box sx={{}}>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Dehradun</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Delhi</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Ghaziabad</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Gos</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Gurgaon</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Scooter Rental</Typography>
          </Box>
          <Box sx={{}}>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Guwahati</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Hyderabad</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Jaipur</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Kolkata</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Leh</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Two Wheeler for Rent</Typography>
          </Box>
          <Box sx={{}}>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Manali</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Mumbai</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Noida</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Pune</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Udaipur</Typography>
            <Typography sx={{fontFamily:"Poppin", fontSize:"18px"}}>Bike on rent in Vizag</Typography>
          </Box>
        </Box>
        <Box sx={{ bgcolor: "#d6fbe6" }}>
          <Box sx={{ py: 5, px: 20 }}>
            ...
            <br />
            <Typography fontFamily={"Poppin"} fontSize={"18px"}>
          ...
          <Box sx={{ py: 5, px: 20 }}>
            <Typography variant="h6" fontFamily={"Poppin"} fontSize={"18px"}>Places to visit in India</Typography>{" "}
            <br />
            <Typography fontFamily={"Poppin"} fontSize={"18px"}>
          ...
          <Box sx={{ py: 5, px: 20 }}>
            <Typography variant="h6" fontFamily={"Poppin"} fontSize={"18px"}>Places to eat in India</Typography> <br />
            <Typography fontFamily={"Poppin"} fontSize={"18px"}>
        ...
        >
          <Typography sx={{ pl: 10, fontFamily: "Poppin", fontSize: "18px" }}>
            {" "}
